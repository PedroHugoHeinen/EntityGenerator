...
[Generator]
public class EntityGeneratorByXml : IIncrementalGenerator
{
    private const string ConsumerNamespace = "AppConsumer";
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        var additionalFiles = context.AdditionalTextsProvider
            .Where(file => file.Path.EndsWith(".Entity.xml"));
        ...
        List<(string Name, string? EntityType, string? DtoType, bool InEntity, bool InDTO)> mapped)
    {
        ...
        stringBuilder.AppendLine(
            $"    public static {className}DTO MapToDTO(this {className} entity) => new {className}DTO");
        stringBuilder.AppendLine("    {");
        ...
        stringBuilder.AppendLine(
            $"    public static {className} MapToEntity(this {className}DTO dto) => new {className}");
        stringBuilder.AppendLine("    {");
